...
async function main() {
  ...
  const settings = [
    ...
    { key: 'STRIPE_ENABLED', value: process.env.STRIPE_ENABLED || 'true', group: 'PAYMENT', label: 'Stripe Enabled', type: 'BOOLEAN', description: 'Enable or disable Stripe checkout across supported payment flows.' },
    ...
    { key: 'SSLCOMMERZ_ENABLED', value: process.env.SSLCOMMERZ_ENABLED || 'true', group: 'PAYMENT', label: 'SSLCommerz Enabled', type: 'BOOLEAN', description: 'Enable or disable SSLCommerz checkout across supported payment flows.' },
    { key: 'SSLCOMMERZ_STORE_ID', value: process.env.SSLCOMMERZ_STORE_ID || '', group: 'PAYMENT', label: 'SSLCommerz Store ID', type: 'STRING', description: 'Merchant store identifier used for SSLCommerz hosted checkout in Bangladesh.' },
    { key: 'SSLCOMMERZ_STORE_PASSWORD', value: process.env.SSLCOMMERZ_STORE_PASSWORD || '', group: 'PAYMENT', label: 'SSLCommerz Store Password', type: 'PASSWORD', isSecret: true, description: 'Store password paired with the SSLCommerz merchant account.' },
    { key: 'SSLCOMMERZ_SANDBOX_MODE', value: process.env.SSLCOMMERZ_SANDBOX_MODE || 'true', group: 'PAYMENT', label: 'SSLCommerz Sandbox Mode', type: 'BOOLEAN', description: 'Use SSLCommerz sandbox endpoints when true, or production endpoints when false.' },
    { key: 'AAMARPAY_ENABLED', value: process.env.AAMARPAY_ENABLED || 'true', group: 'PAYMENT', label: 'aamarPay Enabled', type: 'BOOLEAN', description: 'Enable or disable aamarPay checkout across supported payment flows.' },
    { key: 'AAMARPAY_STORE_ID', value: process.env.AAMARPAY_STORE_ID || '', group: 'PAYMENT', label: 'aamarPay Store ID', type: 'STRING', description: 'Merchant store identifier used for aamarPay hosted checkout in Bangladesh.' },
    { key: 'AAMARPAY_SIGNATURE_KEY', value: process.env.AAMARPAY_SIGNATURE_KEY || '', group: 'PAYMENT', label: 'aamarPay Signature Key', type: 'PASSWORD', isSecret: true, description: 'Signature key paired with the aamarPay merchant account.' },
    { key: 'AAMARPAY_SANDBOX_MODE', value: process.env.AAMARPAY_SANDBOX_MODE || 'true', group: 'PAYMENT', label: 'aamarPay Sandbox Mode', type: 'BOOLEAN', description: 'Use aamarPay sandbox endpoints when true, or production endpoints when false.' },
    { key: 'PAYPAL_ENABLED', value: process.env.PAYPAL_ENABLED || 'false', group: 'PAYMENT', label: 'PayPal Enabled', type: 'BOOLEAN', description: 'Enable or disable PayPal wherever PayPal payment flows are supported.' },
