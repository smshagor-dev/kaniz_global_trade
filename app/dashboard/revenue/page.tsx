...
export default function SupplierRevenuePage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['supplier-commissions', activeFilter],
      ...
      <section className="rounded-[28px] border border-[#d9ddd4] bg-white px-6 py-7 shadow-sm">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-[#1f2937]">Commission visibility</h1>
            <p className="mt-3 max-w-3xl text-sm leading-7 text-[#616b64]">
              See how platform commission is applied to your trade orders with currency-safe totals and full lifecycle visibility.
            </p>
          </div>
      ...
      <section className="overflow-hidden rounded-[28px] border border-[#d9ddd4] bg-white shadow-sm">
        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[1180px] divide-y divide-[#e7eae3] text-sm">
